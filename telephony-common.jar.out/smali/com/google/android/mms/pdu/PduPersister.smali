...
.method private loadParts(J)[Lcom/google/android/mms/pdu/PduPart;
    ...
    invoke-direct {v0, v13, v2}, Lcom/google/android/mms/pdu/PduPersister;->getIntegerFromPartColumn(Landroid/database/Cursor;I)Ljava/lang/Integer;
    ...
    invoke-direct {v0, v13, v2}, Lcom/google/android/mms/pdu/PduPersister;->getByteArrayFromPartColumn(Landroid/database/Cursor;I)[B
    ...
    .line 409
    .local v17, "contentLocation":Ljava/lang/String;
    if-eqz v17, :cond_6
    ...
    invoke-virtual {v10, v11, v2, v3}, Ljava/io/ByteArrayOutputStream;->write([BII)V

    .line 517
    .end local v9    # "applyCharset":Z
    ...
    .end local v17    # "contentLocation":Ljava/lang/String;
    ...
    .restart local v17    # "contentLocation":Ljava/lang/String;
    ...
    .line 473
    .restart local v9    # "applyCharset":Z
    .restart local v11    # "blob":[B
    ...
    const-string v3, "Exception: Failed to load part data, InputStream is null"
    ...
    invoke-virtual {v10, v12, v2, v0}, Ljava/io/ByteArrayOutputStream;->write([BII)V
...
.method private persistData(Lcom/google/android/mms/pdu/PduPart;Landroid/net/Uri;Ljava/lang/String;Ljava/util/HashMap;)V
    ...
    invoke-direct {v3, v4, v12}, Lcom/google/android/mms/pdu/EncodedStringValue;-><init>(I[B)V
    ...
    .line 871
    .restart local v8    # "applyCharset":Z
    ...
    const-string v3, "Null pointer returns from openOutputStream"
    ...
    const-string v3, "Exception: Null pointer returns from openOutputStream"
    ...
    const-string v3, "Null pointer returns from openInputStream"
    ...
    const-string v3, "Exception: Null pointer returns from openInputStream"
    ...
    invoke-virtual {v0, v9, v2, v1}, Ljava/io/OutputStream;->write([BII)V
    ...
    invoke-virtual {v14, v9, v0}, Lcom/google/android/mms/util/DrmConvertSession;->convert([BI)[B
...
.method private updatePart(Landroid/net/Uri;Lcom/google/android/mms/pdu/PduPart;Ljava/util/HashMap;)V
    ...
    invoke-virtual/range {p2 .. p2}, Lcom/google/android/mms/pdu/PduPart;->getCharset()I
    ...
    invoke-virtual/range {p2 .. p2}, Lcom/google/android/mms/pdu/PduPart;->getContentType()[B
    ...
    invoke-virtual/range {p2 .. p2}, Lcom/google/android/mms/pdu/PduPart;->getFilename()[B
    ...
    invoke-virtual/range {p2 .. p2}, Lcom/google/android/mms/pdu/PduPart;->getName()[B
    ...
    invoke-virtual/range {p2 .. p2}, Lcom/google/android/mms/pdu/PduPart;->getContentDisposition()[B
    ...
    .line 1231
    :cond_4
    invoke-virtual/range {p2 .. p2}, Lcom/google/android/mms/pdu/PduPart;->getContentId()[B
    ...
    :cond_5
    invoke-virtual/range {p2 .. p2}, Lcom/google/android/mms/pdu/PduPart;->getContentLocation()[B
    ...
    .line 1247
    invoke-virtual/range {p2 .. p2}, Lcom/google/android/mms/pdu/PduPart;->getData()[B

    move-result-object v4

    if-nez v4, :cond_7

    invoke-virtual/range {p2 .. p2}, Lcom/google/android/mms/pdu/PduPart;->getDataUri()Landroid/net/Uri;
    ...
    invoke-direct {v0, v1, v2, v13, v3}, Lcom/google/android/mms/pdu/PduPersister;->persistData(Lcom/google/android/mms/pdu/PduPart;Landroid/net/Uri;Ljava/lang/String;Ljava/util/HashMap;)V
...
.method public persist(Lcom/google/android/mms/pdu/GenericPdu;Landroid/net/Uri;ZZLjava/util/HashMap;)Landroid/net/Uri;
    ...
    .line 1375
    .restart local v25    # "existingUri":Z
    :cond_2
    ...
    .line 1392
    .local v27, "header":Lcom/google/android/mms/pdu/PduHeaders;
    const/16 v17, 0x0
    ...
    .end local v26    # "field":I
    .end local v27    # "header":Lcom/google/android/mms/pdu/PduHeaders;
    ...
    .restart local v17    # "body":Lcom/google/android/mms/pdu/PduBody;
    .restart local v27    # "header":Lcom/google/android/mms/pdu/PduHeaders;
    ...
    invoke-virtual/range {v37 .. v37}, Lcom/google/android/mms/pdu/PduPart;->getDataLength()I
    ...
    .line 1520
    invoke-static/range {v37 .. v37}, Lcom/google/android/mms/pdu/PduPersister;->getPartContentType(Lcom/google/android/mms/pdu/PduPart;)Ljava/lang/String;
    ...
    .restart local v33    # "messageSize":I
    .restart local v38    # "partsNum":I
    .restart local v42    # "textOnly":Z
    :cond_15
    if-lez v38, :cond_16

    .line 1530
    const-string v6, "dummyId"
    ...
    .restart local v8    # "res":Landroid/net/Uri;
    .restart local v9    # "values":Landroid/content/ContentValues;
    .restart local v13    # "addressMap":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/Integer;[Lcom/google/android/mms/pdu/EncodedStringValue;>;"
...
.method public updateParts(Landroid/net/Uri;Lcom/google/android/mms/pdu/PduBody;Ljava/util/HashMap;)V
    ...
    const-string v23, "purge from cache for uri="
    ...
    const-string v22, "purge from cache for uri="
