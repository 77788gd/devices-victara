...
.field private static final NUMERIC_FROM_SIM:Ljava/lang/String; = "NUMERIC_FROM_SIM"

.field private static final SPN_FROM_SIM:Ljava/lang/String; = "SPN_FROM_SIM"
...
.field protected mOverlaidNumeric:Ljava/lang/String;

.field protected mOverlaidSpn:Ljava/lang/String;

.field protected mParentApp:Lcom/android/internal/telephony/uicc/UiccCardApplication;

.field protected mPotentialBrokerNumeric:Ljava/lang/String;
...
.method public constructor <init>(Lcom/android/internal/telephony/uicc/UiccCardApplication;Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;)V
    ...
    .line 86
    iput-object v2, p0, Lcom/android/internal/telephony/uicc/IccRecords;->mPotentialBrokerNumeric:Ljava/lang/String;
...
.method public getOperatorNumeric()Ljava/lang/String;
    ...
    .prologue
    .line 588
    invoke-virtual {p0}, Lcom/android/internal/telephony/uicc/IccRecords;->getOverlaidOperator()V

    .line 589
    iget-object v0, p0, Lcom/android/internal/telephony/uicc/IccRecords;->mOverlaidNumeric:Ljava/lang/String;

    return-object v0
.end method

.method protected getOperatorNumericOnSIM()Ljava/lang/String;
    .locals 1
...
.method protected getOverlaidOperator()V
    .locals 25
    ...
    iget-object v0, v0, Lcom/android/internal/telephony/uicc/IccRecords;->mOverlaidNumeric:Ljava/lang/String;
    ...
    iget-object v0, v0, Lcom/android/internal/telephony/uicc/IccRecords;->mOverlaidSpn:Ljava/lang/String;
    ...
    iget-object v0, v0, Lcom/android/internal/telephony/uicc/IccRecords;->mPotentialBrokerNumeric:Ljava/lang/String;
    ...
    .line 729
    :cond_2
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/telephony/uicc/IccRecords;->getOperatorNumericOnSIM()Ljava/lang/String;

    move-result-object v15

    .line 730
    .local v15, "numericOnSim":Ljava/lang/String;
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/telephony/uicc/IccRecords;->getSPNOnSIM()Ljava/lang/String;

    move-result-object v20

    .line 731
    .local v20, "spnOnSim":Ljava/lang/String;
    if-eqz v15, :cond_1
    ...
    .line 741
    .local v21, "subContext":Landroid/content/Context;
    ...
    .line 743
    .local v16, "rules":[Ljava/lang/String;
    if-eqz v16, :cond_3
    ...
    iput-object v15, v0, Lcom/android/internal/telephony/uicc/IccRecords;->mOverlaidNumeric:Ljava/lang/String;
    ...
    iput-object v0, v1, Lcom/android/internal/telephony/uicc/IccRecords;->mOverlaidSpn:Ljava/lang/String;
    ...
    .line 756
    .local v8, "curRule":Ljava/lang/String;
    const-string v22, ";"
    ...
    .line 758
    .local v9, "curRuleEntries":[Ljava/lang/String;
    array-length v0, v9
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/uicc/IccRecords;->log(Ljava/lang/String;)V
    ...
    .line 765
    .local v4, "curIdentifier":Ljava/lang/String;
    const/16 v22, 0x1

    aget-object v13, v9, v22

    .line 766
    .local v13, "newNumeric":Ljava/lang/String;
    const/16 v22, 0x2

    aget-object v14, v9, v22

    .line 767
    .local v14, "newSpn":Ljava/lang/String;
    ...
    .line 774
    .local v5, "curIdentifierEntries":[Ljava/lang/String;
    array-length v0, v5
    ...
    const-string v23, "invalid identifier : "
    ...
    .line 781
    .local v6, "curIdentifierKey":Ljava/lang/String;
    const/16 v22, 0x1

    aget-object v7, v5, v22

    .line 782
    .local v7, "curIdentifierValue":Ljava/lang/String;
    ...
    const-string v23, "invalid identifier value: "
    ...
    .line 792
    .local v17, "simGID":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 793
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/telephony/uicc/IccRecords;->getGid1()Ljava/lang/String;
    ...
    .line 807
    const-string v22, "NUMERIC_FROM_SIM"
    ...
    .end local v13    # "newNumeric":Ljava/lang/String;
    :cond_c
    move-object/from16 v0, p0

    iput-object v13, v0, Lcom/android/internal/telephony/uicc/IccRecords;->mOverlaidNumeric:Ljava/lang/String;

    .line 809
    const-string v22, "SPN_FROM_SIM"
    ...
    .end local v14    # "newSpn":Ljava/lang/String;
    :cond_d
    move-object/from16 v0, p0

    iput-object v14, v0, Lcom/android/internal/telephony/uicc/IccRecords;->mOverlaidSpn:Ljava/lang/String;

    .line 840
    .end local v4    # "curIdentifier":Ljava/lang/String;
    .end local v5    # "curIdentifierEntries":[Ljava/lang/String;
    .end local v6    # "curIdentifierKey":Ljava/lang/String;
    .end local v7    # "curIdentifierValue":Ljava/lang/String;
    .end local v8    # "curRule":Ljava/lang/String;
    .end local v9    # "curRuleEntries":[Ljava/lang/String;
    .end local v17    # "simGID":Ljava/lang/String;
    :cond_e
    :goto_4
    move-object/from16 v0, p0
    ...
    const-string v23, "Overlaid Operator Numeric : "
    ...
    const-string v23, "Overlaid Service Provider Name : "
    ...
    .line 795
    .restart local v4    # "curIdentifier":Ljava/lang/String;
    .restart local v5    # "curIdentifierEntries":[Ljava/lang/String;
    .restart local v6    # "curIdentifierKey":Ljava/lang/String;
    .restart local v7    # "curIdentifierValue":Ljava/lang/String;
    .restart local v8    # "curRule":Ljava/lang/String;
    .restart local v9    # "curRuleEntries":[Ljava/lang/String;
    .restart local v13    # "newNumeric":Ljava/lang/String;
    .restart local v14    # "newSpn":Ljava/lang/String;
    .restart local v17    # "simGID":Ljava/lang/String;
    :cond_11
    ...
    invoke-virtual/range {v23 .. v23}, Lcom/android/internal/telephony/uicc/UiccCardApplication;->getPhoneId()I

    move-result v23

    const/16 v24, 0x1

    invoke-virtual/range {v22 .. v24}, Lcom/android/internal/telephony/uicc/UiccController;->getIccRecords(II)Lcom/android/internal/telephony/uicc/IccRecords;

    move-result-object v19

    .line 797
    .local v19, "simRecords":Lcom/android/internal/telephony/uicc/IccRecords;
    if-eqz v19, :cond_b

    .line 798
    invoke-virtual/range {v19 .. v19}, Lcom/android/internal/telephony/uicc/IccRecords;->getGid1()Ljava/lang/String;
    ...
    .line 812
    .end local v17    # "simGID":Ljava/lang/String;
    .end local v19    # "simRecords":Lcom/android/internal/telephony/uicc/IccRecords;
    :cond_12
    ...
    .line 815
    .local v18, "simImsi":Ljava/lang/String;
    move-object/from16 v0, v18

    invoke-static {v7, v0}, Lcom/android/internal/telephony/uicc/IccUtils;->imsiMatches(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 822
    .end local v18    # "simImsi":Ljava/lang/String;
    .restart local v13    # "newNumeric":Ljava/lang/String;
    .restart local v14    # "newSpn":Ljava/lang/String;
    :cond_15
    ...
    const-string v23, "invalid identifier key: "
...
.method protected getSPNOnSIM()Ljava/lang/String;
    .locals 6
...
.method public getServiceProviderName()Ljava/lang/String;
    ...
    .line 354
    iget-object v0, p0, Lcom/android/internal/telephony/uicc/IccRecords;->mOverlaidSpn:Ljava/lang/String;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-virtual {p0, v4}, Lcom/android/internal/telephony/uicc/IccRecords;->handleRefresh(Lcom/android/internal/telephony/uicc/IccRefreshResponse;)V
