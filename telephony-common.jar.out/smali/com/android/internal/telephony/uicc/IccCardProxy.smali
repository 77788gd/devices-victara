...
.method public constructor <init>(Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;I)V
    ...
    .line 128
    iput v3, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mRadioTech:I
...
.method private updateQuietMode()V
    ...
    .line 282
    iget-boolean v5, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mIsCardStatusAvailable:Z
    ...
    .line 254
    .restart local v3    # "newQuietMode":Z
    :goto_4
    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string v8, "updateQuietMode: cdmaSource="
    ...
    const-string v8, " mCurrentAppType="

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget v8, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mCurrentAppType:I

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v7

    const-string v8, " newQuietMode="
    ...
    .end local v2    # "isLteCapable":Z
    .end local v3    # "newQuietMode":Z
    .end local v4    # "oldQuietMode":Z
    :catchall_0
    move-exception v5
    ...
    .restart local v2    # "isLteCapable":Z
    .restart local v4    # "oldQuietMode":Z
    :cond_3
    const/4 v0, -0x1
    ...
    .line 250
    .restart local v1    # "isLteBasedOnCdma":Z
    :cond_5
    if-ne v0, v5, :cond_6
    ...
    .line 274
    :cond_8
    const-string v5, "updateQuietMode: no changes don\'t setExternalState"
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-direct {p0, v9}, Lcom/android/internal/telephony/uicc/IccCardProxy;->loge(Ljava/lang/String;)V
    ...
    .line 294
    iget-boolean v9, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mQuietMode:Z
    ...
    iget-object v10, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mCi:Lcom/android/internal/telephony/CommandsInterface;
    ...
    invoke-direct {p0, v9}, Lcom/android/internal/telephony/uicc/IccCardProxy;->setExternalState(Lcom/android/internal/telephony/IccCardConstants$State;)V
    ...
    .line 305
    iget-boolean v9, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mInitialized:Z
    ...
    .line 325
    const-string v9, "QuietMode: ignore ICC changed "

    invoke-direct {p0, v9}, Lcom/android/internal/telephony/uicc/IccCardProxy;->log(Ljava/lang/String;)V
    ...
    iput-boolean v9, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mIsCardStatusAvailable:Z
    ...
    .line 337
    const-string v9, "QuietMode: ignore SIM absent "
    ...
    .line 341
    :cond_3
    iget-object v9, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mAbsentRegistrants:Landroid/os/RegistrantList;
    ...
    .line 352
    :sswitch_6
    iget-object v9, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mIccRecords:Lcom/android/internal/telephony/uicc/IccRecords;
    ...
    iget-object v10, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mPhoneId:Ljava/lang/Integer;
    ...
    .line 358
    iget-object v9, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mTelephonyManager:Landroid/telephony/TelephonyManager;
    ...
    .line 379
    iget-object v9, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mContext:Landroid/content/Context;

    invoke-virtual {v9, v1}, Landroid/content/Context;->createConfigurationContext(Landroid/content/res/Configuration;)Landroid/content/Context;

    move-result-object v8

    .line 382
    .local v8, "subContext":Landroid/content/Context;
    ...
    .line 385
    .local v4, "isRoamingBrokerHomeOperator":Z
    if-eqz v4, :cond_4

    .line 386
    const-string v9, "persist.radio.dualimsi.hplmn"

    new-instance v10, Ljava/lang/StringBuilder;

    invoke-direct {v10}, Ljava/lang/StringBuilder;-><init>()V

    iget-object v11, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mIccRecords:Lcom/android/internal/telephony/uicc/IccRecords;
    ...
    invoke-direct {p0, v9, v10}, Lcom/android/internal/telephony/uicc/IccCardProxy;->setSystemProperty(Ljava/lang/String;Ljava/lang/String;)V

    .line 395
    .end local v1    # "configuration":Landroid/content/res/Configuration;
    .end local v2    # "countryCode":Ljava/lang/String;
    .end local v4    # "isRoamingBrokerHomeOperator":Z
    .end local v5    # "mcc":Ljava/lang/String;
    .end local v6    # "mnc":Ljava/lang/String;
    .end local v7    # "operator":Ljava/lang/String;
    .end local v8    # "subContext":Landroid/content/Context;
    :cond_4
    :goto_2
    iget-object v9, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mUiccCard:Lcom/android/internal/telephony/uicc/UiccCard;

    if-eqz v9, :cond_7

    iget-object v9, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mUiccCard:Lcom/android/internal/telephony/uicc/UiccCard;

    invoke-virtual {v9}, Lcom/android/internal/telephony/uicc/UiccCard;->areCarrierPriviligeRulesLoaded()Z
    ...
    invoke-virtual {v9, p0, v10, v11}, Lcom/android/internal/telephony/uicc/UiccCard;->registerForCarrierPrivilegeRulesLoaded(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    :cond_5
    const-string v9, "EVENT_RECORDS_LOADED Country code is null"
    ...
    .end local v2    # "countryCode":Ljava/lang/String;
    :cond_6
    const-string v9, "EVENT_RECORDS_LOADED Operator name is null"
    ...
    invoke-direct {p0, v9, v10}, Lcom/android/internal/telephony/uicc/IccCardProxy;->broadcastIccStateChangedIntent(Ljava/lang/String;Ljava/lang/String;)V

    goto/16 :goto_0

    .line 406
    :sswitch_8
    iget-object v9, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mUiccApplication:Lcom/android/internal/telephony/uicc/UiccCardApplication;
    ...
    iput-object v9, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mPersoSubState:Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$PersoSubState;

    .line 407
    iget-object v10, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mPersoLockedRegistrants:Landroid/os/RegistrantList;
    ...
    .line 413
    :sswitch_9
    iget v9, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mRadioTech:I

    invoke-virtual {p0, v9}, Lcom/android/internal/telephony/uicc/IccCardProxy;->setVoiceRadioTech(I)V

    goto/16 :goto_0

    .line 416
    :sswitch_a
    const-string v9, "EVENT_SUBSCRIPTION_ACTIVATED"
    ...
    .line 421
    :sswitch_b
    const-string v9, "EVENT_SUBSCRIPTION_DEACTIVATED"
    ...
    .line 426
    :sswitch_c
    iget v9, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mCurrentAppType:I
    ...
    invoke-virtual {v9, v10, v11}, Landroid/telephony/TelephonyManager;->setSimOperatorNameForPhone(ILjava/lang/String;)V
    ...
    :sswitch_d
    const-string v9, "EVENT_CARRIER_PRIVILEGES_LOADED"
    ...
    invoke-virtual {v9, p0}, Lcom/android/internal/telephony/uicc/UiccCard;->unregisterForCarrierPrivilegeRulesLoaded(Landroid/os/Handler;)V
