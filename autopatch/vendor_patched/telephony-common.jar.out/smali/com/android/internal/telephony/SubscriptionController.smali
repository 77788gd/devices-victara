...
.field private mNwModeChangedRegistrants:Landroid/os/RegistrantList;

.field private mNwModeObservers:[Landroid/database/ContentObserver;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lcom/android/internal/telephony/SubscriptionController;->mNwModeChangedRegistrants:Landroid/os/RegistrantList;

    .line 151
    const/4 v1, 0x0

    iput-object v1, p0, Lcom/android/internal/telephony/SubscriptionController;->mCr:Landroid/content/ContentResolver;
    ...
    new-array v1, v0, [Landroid/database/ContentObserver;

    iput-object v1, p0, Lcom/android/internal/telephony/SubscriptionController;->mNwModeObservers:[Landroid/database/ContentObserver;
...
.method private constructor <init>(Lcom/android/internal/telephony/Phone;)V
    ...
    iput-object v0, p0, Lcom/android/internal/telephony/SubscriptionController;->mNwModeChangedRegistrants:Landroid/os/RegistrantList;

    .line 151
    const/4 v0, 0x0

    iput-object v0, p0, Lcom/android/internal/telephony/SubscriptionController;->mCr:Landroid/content/ContentResolver;
...
.method static synthetic access$100(Lcom/android/internal/telephony/SubscriptionController;Z)V
    .locals 0
    .param p0, "x0"    # Lcom/android/internal/telephony/SubscriptionController;
    .param p1, "x1"    # Z
    ...
    .prologue
    .line 83
    invoke-direct {p0, p1}, Lcom/android/internal/telephony/SubscriptionController;->syncPhonePrefNwModeFromSim(Z)V
...
.method private getDataPhoneId(I)I
    .locals 3
...
.method private getSubNwMode(I)I
    .locals 4
    .param p1, "subId"    # I
    ...
    const-string v2, "NwMode for subId: "
...
.method private initNetworkMode(I)V
    .locals 10
    .param p1, "dataSubId"    # I
    ...
    .line 1894
    invoke-direct {p0, p1}, Lcom/android/internal/telephony/SubscriptionController;->getDataPhoneId(I)I
    ...
    .line 1896
    const-string v7, "data phone is not available, shouldn\'t be here"
    ...
    invoke-static {v7, v8, v0}, Landroid/telephony/TelephonyManager;->getIntAtIndex(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    :try_end_0
    ...
    invoke-static {v7, v8, v0, v5}, Landroid/telephony/TelephonyManager;->putIntAtIndex(Landroid/content/ContentResolver;Ljava/lang/String;II)Z
    ...
    invoke-static {v7, v8, v4}, Landroid/telephony/TelephonyManager;->getIntAtIndex(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    :try_end_1
    ...
    invoke-static {v7, v8, v4, v9}, Landroid/telephony/TelephonyManager;->putIntAtIndex(Landroid/content/ContentResolver;Ljava/lang/String;II)Z

    .line 1929
    const/4 v3, 0x1

    .line 1915
    .end local v2    # "limitPhoneNwMode":I
    :cond_3
    ...
    .line 1903
    .end local v1    # "dataPhoneNwMode":I
    .end local v3    # "modeChanged":Z
    .end local v4    # "phoneId":I
    .end local v5    # "prefDataSubNwMode":I
    :catch_0
    move-exception v6

    .line 1904
    .local v6, "snfe":Landroid/provider/Settings$SettingNotFoundException;
    const-string v7, "initNetworkMode: network mode is not found"
    ...
    .restart local v1    # "dataPhoneNwMode":I
    goto :goto_1

    .line 1921
    .end local v6    # "snfe":Landroid/provider/Settings$SettingNotFoundException;
    .restart local v3    # "modeChanged":Z
    .restart local v4    # "phoneId":I
    .restart local v5    # "prefDataSubNwMode":I
    :catch_1
    move-exception v6

    .line 1922
    .restart local v6    # "snfe":Landroid/provider/Settings$SettingNotFoundException;
    const-string v7, "initNetworkMode: network mode is not found"
    ...
    .restart local v2    # "limitPhoneNwMode":I
    goto :goto_3
    ...
    .line 1934
    iget-object v7, p0, Lcom/android/internal/telephony/SubscriptionController;->mNwModeChangedRegistrants:Landroid/os/RegistrantList;
...
.method private isNetworkModeAutoSwitch()Z
    .locals 3
    ...
    const v2, #android:bool@auto_nwmode_switch_enabled#t
    ...
    .line 1961
    const-string v1, "isNetworkModeAutoSwitch: true"
...
.method private isNetworkModeLimited()Z
    .locals 3
    ...
    const v2, #android:bool@ds_network_mode_limited#t
    ...
    .line 1951
    const-string v1, "isNetorkModeLimited: true"
...
.method private nwModeConfigIsInvalid(I)Z
    .locals 8
    .param p1, "dataSubId"    # I
    ...
    .line 1864
    const-string v6, "data phone is not available, shouldn\'t be here"
    ...
    .line 1868
    :cond_0
    invoke-direct {p0, p1}, Lcom/android/internal/telephony/SubscriptionController;->getSubNwMode(I)I
    ...
    .line 1869
    const-string v6, "nwModeConfigIsInvalid: sim nw are not initialized."
    ...
    invoke-static {v6, v7, v3}, Landroid/telephony/TelephonyManager;->getIntAtIndex(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    :try_end_0
    .catch Landroid/provider/Settings$SettingNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 1885
    .local v1, "limitSubNwMode":I
    if-eq v1, v5, :cond_2

    .line 1886
    const-string v6, "nw mode was wrong, correct it"
    ...
    .line 1881
    .end local v1    # "limitSubNwMode":I
    :catch_0
    move-exception v4

    .line 1882
    .local v4, "snfe":Landroid/provider/Settings$SettingNotFoundException;
    const-string v6, "nwModeConfigIsInvalid: network mode is not found"
...
.method private registerForNwModeChange(II)V
    .locals 4
    .param p1, "phoneId"    # I
    .param p2, "subId"    # I
    ...
    .prologue
    .line 1779
    iget-object v0, p0, Lcom/android/internal/telephony/SubscriptionController;->mNwModeObservers:[Landroid/database/ContentObserver;

    new-instance v1, Lcom/android/internal/telephony/SubscriptionController$2;

    new-instance v2, Landroid/os/Handler;

    invoke-direct {v2}, Landroid/os/Handler;-><init>()V

    invoke-direct {v1, p0, v2}, Lcom/android/internal/telephony/SubscriptionController$2;-><init>(Lcom/android/internal/telephony/SubscriptionController;Landroid/os/Handler;)V

    aput-object v1, v0, p1

    .line 1787
    iget-object v0, p0, Lcom/android/internal/telephony/SubscriptionController;->mCr:Landroid/content/ContentResolver;
    ...
    iget-object v3, p0, Lcom/android/internal/telephony/SubscriptionController;->mNwModeObservers:[Landroid/database/ContentObserver;
...
.method private setSubNwMode(II)V
    .locals 3
    .param p1, "subId"    # I
    .param p2, "nwMode"    # I
...
.method private syncPhonePrefNwModeFromSim(Z)V
    .locals 9
    ...
    invoke-static {v7, v8, v2}, Landroid/telephony/TelephonyManager;->getIntAtIndex(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    :try_end_0
    .catch Landroid/provider/Settings$SettingNotFoundException; {:try_start_0 .. :try_end_0} :catch_0

    move-result v3

    .local v3, "phoneNwMode":I
    :goto_1
    invoke-virtual {p0, v2}, Lcom/android/internal/telephony/SubscriptionController;->getSubIdUsingPhoneId(I)I
    ...
    invoke-direct {p0, v5}, Lcom/android/internal/telephony/SubscriptionController;->getSubNwMode(I)I

    move-result v6

    .local v6, "subNwMode":I
    if-eq v3, v6, :cond_0
    ...
    invoke-static {v7, v8, v2, v6}, Landroid/telephony/TelephonyManager;->putIntAtIndex(Landroid/content/ContentResolver;Ljava/lang/String;II)Z

    const/4 v0, 0x1

    .end local v6    # "subNwMode":I
    :cond_0
    add-int/lit8 v2, v2, 0x1

    goto :goto_0

    .end local v3    # "phoneNwMode":I
    .end local v5    # "subId":I
    :catch_0
    move-exception v4

    .local v4, "snfe":Landroid/provider/Settings$SettingNotFoundException;
    const-string v7, "network mode is not found"

    invoke-direct {p0, v7}, Lcom/android/internal/telephony/SubscriptionController;->loge(Ljava/lang/String;)V

    const/4 v3, -0x1

    .restart local v3    # "phoneNwMode":I
    goto :goto_1
...
.method private syncSimNwModeFromPhonePref()V
    .locals 7
    ...
    invoke-static {v5, v6, v2}, Landroid/telephony/TelephonyManager;->getIntAtIndex(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    :try_end_0
    .catch Landroid/provider/Settings$SettingNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-direct {p0, v4, v0}, Lcom/android/internal/telephony/SubscriptionController;->setSubNwMode(II)V
    ...
    const-string v5, "network mode is not found"
...
.method public activateSubId(I)V
    ...
    const-string v1, "activateSubId: subscription already active"
...
.method public addSubInfoRecord(Ljava/lang/String;I)I
    ...
    invoke-virtual {v3, v0}, Landroid/telephony/TelephonyManager;->getSimOperatorNameForSubscription(I)Ljava/lang/String;
    ...
    .restart local v12    # "nameSource":I
    .restart local v15    # "simCarrierName":Ljava/lang/String;
    .restart local v16    # "subId":I
    .restart local v17    # "subIdCountMax":I
    .restart local v19    # "value":Landroid/content/ContentValues;
    :cond_f
    :try_start_3
    new-instance v3, Ljava/lang/StringBuilder;
...
.method public getSimStateForSubscriber(I)I
    ...
    invoke-virtual {v4}, Lcom/android/internal/telephony/IccCardConstants$State;->getState()I
...
.method public registerForNetworkModeChanged(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    iget-object v1, p0, Lcom/android/internal/telephony/SubscriptionController;->mNwModeChangedRegistrants:Landroid/os/RegistrantList;
...
.method public setDefaultDataSubId(I)V
    ...
    const-string v7, "invalid requrest for setDefaultDataSubId since the subid isn\'t changed "
...
.method public setDefaultSmsSubId(I)V
    ...
    const-string v0, "invalid requrest for setDefaultSmsSubId since the subid isn\'t changed "
...
.method public setDefaultVoiceSubId(I)V
    ...
    const-string v0, "invalid requrest for setDefaultVoiceSubId since the subid isn\'t changed "
...
.method public unregisterForNetworkModeChanged(Landroid/os/Handler;)V
    ...
    .prologue
    iget-object v0, p0, Lcom/android/internal/telephony/SubscriptionController;->mNwModeChangedRegistrants:Landroid/os/RegistrantList;
...
.method public updateSubState(II)I
    .locals 8
    .param p1, "subId"    # I
    ...
    const-string v3, "setSubState, subStatus: "
...
.method public updateUserPrefs()V
    ...
    .prologue
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/telephony/SubscriptionController;->getActiveSubscriptionInfoList()Ljava/util/List;

    move-result-object v18

    .local v18, "subInfoList":Ljava/util/List;, "Ljava/util/List<Landroid/telephony/SubscriptionInfo;>;"
    const/4 v11, 0x0

    .local v11, "mActCount":I
    const/4 v12, 0x0

    .local v12, "mNextActivatedSub":Landroid/telephony/SubscriptionInfo;
    if-nez v18, :cond_1

    const-string v19, "updateUserPrefs: subscription are not avaiable "
    ...
    .local v8, "isDefSmsSubIdAvail":Z
    const/4 v9, 0x0

    .local v9, "isDefVoiceSubIdAvail":Z
    const/4 v7, 0x0

    .local v7, "isDefDataSubIdAvail":Z
    ...
    invoke-virtual/range {v17 .. v17}, Landroid/telephony/SubscriptionInfo;->getStatus()I
    ...
    sget-boolean v19, Lcom/android/internal/telephony/SubscriptionController;->VDBG:Z

    if-eqz v19, :cond_7

    const-string v19, "force SMSPromptEnabled as true"
    ...
    const-string v20, "initialize SMS subId as "
    ...
    const-string v20, "initialize voice subId as "
    ...
    const-string v20, "initialize data subId as "
    ...
    const-string v20, "adjust fallback subId as "
    ...
    sget v19, Lcom/android/internal/telephony/SubscriptionController;->mDefaultFallbackSubId:I
    ...
    const v20, #android:bool@ds_network_mode_is_locked_to_slot#t

    invoke-virtual/range {v19 .. v20}, Landroid/content/res/Resources;->getBoolean(I)Z

    move-result v10

    .local v10, "isNetworkModeLockedToSlot":Z
    invoke-direct/range {p0 .. p0}, Lcom/android/internal/telephony/SubscriptionController;->isNetworkModeLimited()Z
    ...
    invoke-static {v0, v1, v5}, Landroid/telephony/TelephonyManager;->getIntAtIndex(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    :try_end_0
    .catch Landroid/provider/Settings$SettingNotFoundException; {:try_start_0 .. :try_end_0} :catch_0

    move-result v14

    .local v14, "phoneNwMode":I
    :goto_2
    move-object/from16 v0, p0

    invoke-virtual {v0, v5}, Lcom/android/internal/telephony/SubscriptionController;->getSubIdUsingPhoneId(I)I
    ...
    iget-object v0, v0, Lcom/android/internal/telephony/SubscriptionController;->mNwModeObservers:[Landroid/database/ContentObserver;
    ...
    iget-object v0, v0, Lcom/android/internal/telephony/SubscriptionController;->mCr:Landroid/content/ContentResolver;
    ...
    invoke-direct {v0, v1, v14}, Lcom/android/internal/telephony/SubscriptionController;->setSubNwMode(II)V
    ...
    invoke-direct {v0, v5, v1}, Lcom/android/internal/telephony/SubscriptionController;->registerForNwModeChange(II)V
    ...
    .restart local v14    # "phoneNwMode":I
    new-instance v19, Ljava/lang/StringBuilder;

    invoke-direct/range {v19 .. v19}, Ljava/lang/StringBuilder;-><init>()V

    const-string v20, "network for phoneId-"
    ...
    :cond_12
    invoke-direct/range {p0 .. p0}, Lcom/android/internal/telephony/SubscriptionController;->isNetworkModeAutoSwitch()Z
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/internal/telephony/SubscriptionController;->syncSimNwModeFromPhonePref()V
    ...
    invoke-direct {v0, v2}, Lcom/android/internal/telephony/SubscriptionController;->nwModeConfigIsInvalid(I)Z
    ...
    invoke-direct {v0, v2}, Lcom/android/internal/telephony/SubscriptionController;->initNetworkMode(I)V
    ...
    invoke-direct {v0, v1}, Lcom/android/internal/telephony/SubscriptionController;->syncPhonePrefNwModeFromSim(Z)V
