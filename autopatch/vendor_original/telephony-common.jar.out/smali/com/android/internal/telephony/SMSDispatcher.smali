...
.method private sendMultipartSms(Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;)V
    ...
    .end local v1    # "destinationAddress":Ljava/lang/String;
    ...
    :cond_0
    invoke-static {v13, v11}, Lcom/android/internal/telephony/SMSDispatcher;->handleNotInService(ILandroid/app/PendingIntent;)V
    ...
    .end local v9    # "i":I
    .end local v11    # "sentIntent":Landroid/app/PendingIntent;
    .restart local v1    # "destinationAddress":Ljava/lang/String;
    .restart local v2    # "scAddress":Ljava/lang/String;
    .restart local v3    # "parts":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
...
.method protected sendMultipartText(Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Landroid/net/Uri;Ljava/lang/String;)V
    ...
    iget v4, v0, Lcom/android/internal/telephony/GsmAlphabet$TextEncodingDetails;->languageTable:I
    ...
    iget v4, v0, Lcom/android/internal/telephony/GsmAlphabet$TextEncodingDetails;->languageShiftTable:I
    ...
    .end local v10    # "sentIntent":Landroid/app/PendingIntent;
    .end local v11    # "deliveryIntent":Landroid/app/PendingIntent;
    .end local v13    # "unsentPartCount":Ljava/util/concurrent/atomic/AtomicInteger;
    .end local v14    # "anyPartFailed":Ljava/util/concurrent/atomic/AtomicBoolean;
    .end local v19    # "concatRef":Lcom/android/internal/telephony/SmsHeader$ConcatRef;
    .end local v21    # "i":I
    .end local v28    # "trackers":[Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;
    :cond_3
    const/4 v9, 0x0
    ...
    .restart local v10    # "sentIntent":Landroid/app/PendingIntent;
    .restart local v11    # "deliveryIntent":Landroid/app/PendingIntent;
    .restart local v13    # "unsentPartCount":Ljava/util/concurrent/atomic/AtomicInteger;
    .restart local v14    # "anyPartFailed":Ljava/util/concurrent/atomic/AtomicBoolean;
    .restart local v19    # "concatRef":Lcom/android/internal/telephony/SmsHeader$ConcatRef;
    .restart local v21    # "i":I
    .restart local v28    # "trackers":[Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;
    :cond_4
    const/4 v12, 0x0
    ...
    .line 901
    new-instance v26, Lcom/android/internal/telephony/SMSDispatcher$MultipartSmsSender;
    ...
    .line 902
    .local v26, "smsSender":Lcom/android/internal/telephony/SMSDispatcher$MultipartSmsSender;
    ...
    .line 904
    .end local v26    # "smsSender":Lcom/android/internal/telephony/SMSDispatcher$MultipartSmsSender;
    :cond_9
    const-string v4, "SMSDispatcher"
