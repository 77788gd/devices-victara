...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/internal/telephony/RIL$TLV;,
...
# static fields
.field private static final ACTION_SPEECH_CODEC:Ljava/lang/String; = "com.motorola.android.intent.action.ACTION_SPEECH_CODEC"
...
.field static final RIL_MAX_COMMAND_BYTES:I = 0x4400
...
# instance fields
.field final EMBMS_MESSAGE_UNSOLSIB16_COVERAGE:I

.field final OEMHOOK_BASE:I

.field final OEMHOOK_TUNNELING_SERVICE_EMBMS:I
...
.field final OEMHOOK_UNSOL_GENERIC:I

.field final OEMHOOK_UNSOL_SPEECH_CODEC_IND:I
...
.field private mSpeechCodecEnabled:Z
...
.method public constructor <init>(Landroid/content/Context;IILjava/lang/Integer;)V
    ...
    iput v5, p0, Lcom/android/internal/telephony/RIL;->OEMHOOK_BASE:I

    .line 244
    const v5, 0x803e9

    iput v5, p0, Lcom/android/internal/telephony/RIL;->OEMHOOK_UNSOL_CDMA_BURST_DTMF:I

    .line 245
    const v5, 0x803ea

    iput v5, p0, Lcom/android/internal/telephony/RIL;->OEMHOOK_UNSOL_CDMA_CONT_DTMF_START:I

    .line 246
    const v5, 0x803eb

    iput v5, p0, Lcom/android/internal/telephony/RIL;->OEMHOOK_UNSOL_CDMA_CONT_DTMF_STOP:I

    .line 247
    const v5, 0x803f1

    iput v5, p0, Lcom/android/internal/telephony/RIL;->OEMHOOK_UNSOL_WMS_READY:I

    .line 249
    const v5, 0x8044c

    iput v5, p0, Lcom/android/internal/telephony/RIL;->OEMHOOK_UNSOL_GENERIC:I

    .line 250
    const/4 v5, 0x2

    iput v5, p0, Lcom/android/internal/telephony/RIL;->OEMHOOK_TUNNELING_SERVICE_EMBMS:I

    .line 251
    const/16 v5, 0x19

    iput v5, p0, Lcom/android/internal/telephony/RIL;->EMBMS_MESSAGE_UNSOLSIB16_COVERAGE:I

    .line 254
    const v5, 0x4000d

    iput v5, p0, Lcom/android/internal/telephony/RIL;->OEMHOOK_UNSOL_SPEECH_CODEC_IND:I
    ...
    .line 281
    iput-boolean v9, p0, Lcom/android/internal/telephony/RIL;->mIsShutingDown:Z

    .line 309
    iput-boolean v9, p0, Lcom/android/internal/telephony/RIL;->mSpeechCodecEnabled:Z
    ...
    iput-boolean v5, p0, Lcom/android/internal/telephony/RIL;->mSpeechCodecEnabled:Z
...
.method private broadcastSpeechCodecIntent([B)V
    .locals 9
    .param p1, "data"    # [B

    .prologue
    .line 3421
    iget-boolean v6, p0, Lcom/android/internal/telephony/RIL;->mSpeechCodecEnabled:Z
    ...
    const-string v6, "com.motorola.android.intent.action.ACTION_SPEECH_CODEC"
    ...
    .line 3427
    .local v3, "payloadBuff":Ljava/nio/ByteBuffer;
    ...
    .line 3433
    .local v4, "speechCodec":I
    invoke-virtual {v3}, Ljava/nio/ByteBuffer;->getInt()I

    move-result v5

    .line 3434
    .local v5, "speechEncSampFreq":I
    ...
    .line 3438
    iget-object v6, p0, Lcom/android/internal/telephony/RIL;->mContext:Landroid/content/Context;

    const-string v7, "android.permission.CALL_PRIVILEGED"
    ...
    const-string v8, "Broadcast intent ACTION_SPEECH_CODEC : callID="
    ...
    .end local v3    # "payloadBuff":Ljava/nio/ByteBuffer;
    .end local v4    # "speechCodec":I
    .end local v5    # "speechEncSampFreq":I
    :catch_0
    move-exception v1
    ...
    const-string v8, "Speech codec exception : "
...
.method private handleQCGenericUnsol([B)V
    .locals 5
    .param p1, "data"    # [B
    ...
    const-string v4, "Unknown service ID, could not be handled : "
    ...
    .line 3462
    :pswitch_0
    invoke-direct {p0, v0}, Lcom/android/internal/telephony/RIL;->handleTunnelingServiceEMBMS(Ljava/nio/ByteBuffer;)V
...
.method private handleTunnelingServiceEMBMS(Ljava/nio/ByteBuffer;)V
    .locals 5
    ...
    const-string v4, "Unknown message ID, could not be handled : "
    ...
    .line 3476
    :pswitch_0
    new-instance v1, Lcom/android/internal/telephony/RIL$TLV;

    const/4 v2, 0x0

    invoke-direct {v1, p0, v2}, Lcom/android/internal/telephony/RIL$TLV;-><init>(Lcom/android/internal/telephony/RIL;Lcom/android/internal/telephony/RIL$1;)V

    .line 3477
    .local v1, "tlvObj":Lcom/android/internal/telephony/RIL$TLV;
    # invokes: Lcom/android/internal/telephony/RIL$TLV;->readFromByteBuffer(Ljava/nio/ByteBuffer;)V
    invoke-static {v1, p1}, Lcom/android/internal/telephony/RIL$TLV;->access$1100(Lcom/android/internal/telephony/RIL$TLV;Ljava/nio/ByteBuffer;)V

    .line 3479
    # getter for: Lcom/android/internal/telephony/RIL$TLV;->value:[B
    invoke-static {v1}, Lcom/android/internal/telephony/RIL$TLV;->access$1200(Lcom/android/internal/telephony/RIL$TLV;)[B
    ...
    invoke-direct {p0, v2}, Lcom/android/internal/telephony/RIL;->notifySIB16Coverage([B)V
...
.method private notifySIB16Coverage([B)V
    .locals 3
    .param p1, "data"    # [B
    ...
    iget-object v1, p0, Lcom/android/internal/telephony/RIL;->mSIB16CoverageRegistrants:Landroid/os/RegistrantList;
    ...
    const-string v2, "SIB16_Coverage notified to registrants"
...
.method private processUnsolOemhookResponse(Ljava/nio/ByteBuffer;)V
    ...
    .line 3384
    :sswitch_4
    invoke-direct {p0, v0}, Lcom/android/internal/telephony/RIL;->handleQCGenericUnsol([B)V

    goto :goto_0

    .line 3390
    :sswitch_5
    invoke-direct {p0, v0}, Lcom/android/internal/telephony/RIL;->broadcastSpeechCodecIntent([B)V
...
.method private processUnsolicited(Landroid/os/Parcel;)V
    ...
    iget-boolean v0, v0, Lcom/android/internal/telephony/RIL;->mIsShutingDown:Z
...
.method private responseSignalStrength(Landroid/os/Parcel;)Ljava/lang/Object;
    ...
    .local v1, "slotId":I
    :goto_0
    invoke-static {p1, v1}, Landroid/telephony/SignalStrength;->makeSignalStrengthFromRilParcel(Landroid/os/Parcel;I)Landroid/telephony/SignalStrength;
...
.method public requestShutdown(Landroid/os/Message;)V
    ...
    iput-boolean v1, p0, Lcom/android/internal/telephony/RIL;->mIsShutingDown:Z
