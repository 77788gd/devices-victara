...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/internal/telephony/CallManager$EmergencyCallHelper;,
...
.field mEmergencyCallHelper:Lcom/android/internal/telephony/CallManager$EmergencyCallHelper;
...
.method public notifyCallDisconnected(Ljava/lang/Object;)V
    .locals 14
    .param p1, "obj"    # Ljava/lang/Object;

    .prologue
    .line 2537
    instance-of v10, p1, Landroid/os/AsyncResult;
    ...
    instance-of v10, v10, Lcom/android/internal/telephony/Connection;
    ...
    const-string v10, "com.motorola.android.intent.action.ACTION_CALL_DISCONNECTED"
    ...
    invoke-virtual {v7, v10, v12, v13}, Landroid/content/Intent;->putExtra(Ljava/lang/String;J)Landroid/content/Intent;
    ...
    .line 2547
    const-string v10, "disconnected_time"

    invoke-virtual {v5}, Lcom/android/internal/telephony/Connection;->getDisconnectTime()J
    ...
    .line 2548
    const-string v10, "disconnected_cause"
    ...
    .line 2554
    .local v4, "ca":Lcom/android/internal/telephony/Call;
    if-eqz v4, :cond_0
    ...
    .line 2556
    .local v8, "ph":Lcom/android/internal/telephony/Phone;
    if-eqz v8, :cond_0
    ...
    .line 2560
    .end local v8    # "ph":Lcom/android/internal/telephony/Phone;
    :cond_0
    const/4 v10, -0x1
    ...
    .line 2566
    .end local v4    # "ca":Lcom/android/internal/telephony/Call;
    .end local v9    # "subId":I
    :cond_1
    const/4 v0, 0x1

    .line 2567
    .local v0, "CALL_DOMAIN_CS":I
    const/4 v2, 0x2

    .line 2568
    .local v2, "CALL_DOMAIN_PS":I
    const/4 v1, 0x4

    .line 2569
    .local v1, "CALL_DOMAIN_NOT_SET":I
    const/4 v6, 0x4

    .line 2570
    .local v6, "domain":I
    instance-of v10, v5, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;
    ...
    invoke-virtual {v7, v10, v6}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    .line 2580
    const-string v10, "type"

    invoke-virtual {v5}, Lcom/android/internal/telephony/Connection;->getVideoState()I
    ...
    .line 2589
    .end local v0    # "CALL_DOMAIN_CS":I
    .end local v1    # "CALL_DOMAIN_NOT_SET":I
    .end local v2    # "CALL_DOMAIN_PS":I
    ...
    .line 2572
    .restart local v0    # "CALL_DOMAIN_CS":I
    .restart local v1    # "CALL_DOMAIN_NOT_SET":I
    .restart local v2    # "CALL_DOMAIN_PS":I
    .restart local v3    # "ar":Landroid/os/AsyncResult;
    .restart local v5    # "cn":Lcom/android/internal/telephony/Connection;
    .restart local v6    # "domain":I
    .restart local v7    # "intent":Landroid/content/Intent;
    :cond_3
    instance-of v10, v5, Lcom/android/internal/telephony/cdma/CdmaConnection;
    ...
    .line 2574
    :cond_4
    instance-of v10, v5, Lcom/android/internal/telephony/gsm/GsmConnection;
...
.method public registerPhone(Lcom/android/internal/telephony/Phone;)Z
    ...
    .line 439
    iget-object v1, p0, Lcom/android/internal/telephony/CallManager;->mEmergencyCallHelper:Lcom/android/internal/telephony/CallManager$EmergencyCallHelper;

    if-nez v1, :cond_1

    .line 440
    new-instance v1, Lcom/android/internal/telephony/CallManager$EmergencyCallHelper;

    invoke-direct {v1, p0}, Lcom/android/internal/telephony/CallManager$EmergencyCallHelper;-><init>(Lcom/android/internal/telephony/CallManager;)V

    iput-object v1, p0, Lcom/android/internal/telephony/CallManager;->mEmergencyCallHelper:Lcom/android/internal/telephony/CallManager$EmergencyCallHelper;
