...
.method public enter()V
    ...
    invoke-static {v0, v2}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->access$3400(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;Z)V
    ...
    invoke-static {v0}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->access$3700(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;)V
    ...
    invoke-static {v0, v1}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->access$3802(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;Z)Z
    ...
    invoke-static {v0}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->access$3900(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;)Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$PreviouslyConnectedDeviceInfo;

    move-result-object v0

    const/4 v1, 0x0

    iput-object v1, v0, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$PreviouslyConnectedDeviceInfo;->mP2pDeviceInfo:Landroid/net/wifi/p2p/WifiP2pDevice;
    ...
    iput-wide v2, v0, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$PreviouslyConnectedDeviceInfo;->mAutoConnectTime:J
...
.method public exit()V
    ...
    invoke-static {v0, v1}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->access$5000(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;Z)V

    .line 1597
    iget-object v0, p0, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine$P2pEnabledState;->this$1:Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;

    # invokes: Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->sendP2pStateChangedBroadcast(Z)V
    invoke-static {v0, v1}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->access$3400(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;Z)V
    ...
    invoke-static {v0, v1}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->access$6302(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;Ljava/lang/String;)Ljava/lang/String;
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static/range {v25 .. v26}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->access$4000(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;Lcom/android/internal/util/IState;)V
    ...
    invoke-static/range {v25 .. v25}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->access$2100(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;)Landroid/net/wifi/p2p/WifiP2pGroupList;
    ...
    invoke-static/range {v25 .. v25}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->access$1300(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;)V
    ...
    invoke-static/range {v25 .. v25}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->access$2700(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;)Lcom/android/server/wifi/WifiMonitor;

    move-result-object v25

    invoke-virtual/range {v25 .. v25}, Lcom/android/server/wifi/WifiMonitor;->stopMonitoring()V
    ...
    invoke-static/range {v26 .. v26}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->access$4200(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;)Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine$P2pDisablingState;

    move-result-object v26

    # invokes: Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static/range {v25 .. v26}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->access$4300(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;Lcom/android/internal/util/IState;)V
    ...
    .line 1265
    .local v10, "d":Landroid/net/wifi/p2p/WifiP2pDevice;
    if-eqz v10, :cond_3
    ...
    iget-object v0, v10, Landroid/net/wifi/p2p/WifiP2pDevice;->deviceName:Ljava/lang/String;

    move-object/from16 v26, v0

    # invokes: Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->setAndPersistDeviceName(Ljava/lang/String;)Z
    invoke-static/range {v25 .. v26}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->access$4400(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;Ljava/lang/String;)Z
    ...
    .line 1276
    .end local v10    # "d":Landroid/net/wifi/p2p/WifiP2pDevice;
    :sswitch_4
    move-object/from16 v0, p1

    iget-object v10, v0, Landroid/os/Message;->obj:Ljava/lang/Object;

    check-cast v10, Landroid/net/wifi/p2p/WifiP2pWfdInfo;

    .line 1277
    .local v10, "d":Landroid/net/wifi/p2p/WifiP2pWfdInfo;
    if-eqz v10, :cond_4
    ...
    invoke-static {v0, v10}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->access$4600(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;Landroid/net/wifi/p2p/WifiP2pWfdInfo;)Z
    ...
    .line 1286
    .end local v10    # "d":Landroid/net/wifi/p2p/WifiP2pWfdInfo;
    :sswitch_5
    move-object/from16 v0, p1
    ...
    invoke-static/range {v25 .. v25}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->access$1600(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;)Z
    ...
    invoke-static {v0, v5}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->access$1602(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;Z)Z
    ...
    invoke-static/range {v25 .. v25}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->access$4700(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;)Z
    ...
    invoke-static/range {v25 .. v26}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->access$1702(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;Z)Z
    ...
    invoke-static/range {v25 .. v25}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->access$1700(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;)Z
    ...
    invoke-virtual/range {v25 .. v26}, Lcom/android/server/wifi/WifiNative;->p2pFind(I)Z
    ...
    # invokes: Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->logi(Ljava/lang/String;)V
    invoke-static/range {v25 .. v26}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->access$4800(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;Ljava/lang/String;)V
    ...
    invoke-static/range {v25 .. v25}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->access$4900(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;)V
    ...
    # invokes: Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->sendP2pDiscoveryChangedBroadcast(Z)V
    invoke-static/range {v25 .. v26}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->access$5000(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;Z)V
    ...
    const-string v27, "Enable wifi network"
    ...
    # invokes: Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->startWifiScan()V
    invoke-static/range {v25 .. v25}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->access$5200(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;)V
    ...
    invoke-static/range {v25 .. v25}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->access$5300(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;)Z
    ...
    .line 1370
    .local v12, "device":Landroid/net/wifi/p2p/WifiP2pDevice;
    move-object/from16 v0, p0
    ...
    invoke-static/range {v25 .. v25}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->access$5400(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;)Landroid/net/wifi/p2p/WifiP2pDevice;
    ...
    invoke-virtual {v0, v12}, Landroid/net/wifi/p2p/WifiP2pDeviceList;->updateSupplicantDetails(Landroid/net/wifi/p2p/WifiP2pDevice;)V
    ...
    invoke-static/range {v25 .. v25}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->access$500(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;)Landroid/net/wifi/p2p/WifiP2pInfo;
    ...
    .line 1380
    iget v0, v12, Landroid/net/wifi/p2p/WifiP2pDevice;->groupCapability:I
    ...
    invoke-virtual/range {v25 .. v26}, Landroid/net/wifi/p2p/WifiP2pGroupList;->getNetworkId(Ljava/lang/String;)I
    ...
    iget-wide v0, v0, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$PreviouslyConnectedDeviceInfo;->mAutoConnectTime:J
    ...
    iput-object v0, v8, Landroid/net/wifi/p2p/WifiP2pConfig;->deviceAddress:Ljava/lang/String;
    ...
    invoke-virtual {v0, v1, v2, v3, v8}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;

    move-result-object v26

    invoke-virtual/range {v25 .. v26}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->sendMessage(Landroid/os/Message;)V
    ...
    const-string v27, "Blocked for two mins..."
    ...
    # getter for: Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->mPreviouslyConnectedDeviceInfo:Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$PreviouslyConnectedDeviceInfo;
    invoke-static/range {v27 .. v27}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->access$3900(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;)Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$PreviouslyConnectedDeviceInfo;
    ...
    .line 1407
    .end local v8    # "config":Landroid/net/wifi/p2p/WifiP2pConfig;
    .end local v12    # "device":Landroid/net/wifi/p2p/WifiP2pDevice;
    :sswitch_b
    move-object/from16 v0, p1
    ...
    .line 1409
    .restart local v12    # "device":Landroid/net/wifi/p2p/WifiP2pDevice;
    move-object/from16 v0, p0
    ...
    check-cast v24, Landroid/net/wifi/p2p/nsd/WifiP2pServiceInfo;

    .line 1417
    .local v24, "servInfo":Landroid/net/wifi/p2p/nsd/WifiP2pServiceInfo;
    move-object/from16 v0, p0
    ...
    invoke-static {v0, v1, v2}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->access$5600(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;Landroid/os/Messenger;Landroid/net/wifi/p2p/nsd/WifiP2pServiceInfo;)Z
    ...
    .line 1424
    .end local v24    # "servInfo":Landroid/net/wifi/p2p/nsd/WifiP2pServiceInfo;
    :sswitch_d
    move-object/from16 v0, p0
    ...
    .line 1426
    .restart local v24    # "servInfo":Landroid/net/wifi/p2p/nsd/WifiP2pServiceInfo;
    move-object/from16 v0, p0
    ...
    invoke-static {v0, v1, v2}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->access$5700(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;Landroid/os/Messenger;Landroid/net/wifi/p2p/nsd/WifiP2pServiceInfo;)V
    ...
    invoke-static/range {v25 .. v26}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->access$5800(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;Landroid/os/Messenger;)V
    ...
    invoke-static {v0, v1, v2}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->access$5900(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;Landroid/os/Messenger;Landroid/net/wifi/p2p/nsd/WifiP2pServiceRequest;)Z
    ...
    invoke-static {v0, v1, v2}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->access$6000(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;Landroid/os/Messenger;Landroid/net/wifi/p2p/nsd/WifiP2pServiceRequest;)V
    ...
    invoke-static/range {v25 .. v26}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->access$6100(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;Landroid/os/Messenger;)V
    ...
    invoke-virtual {v0, v11}, Landroid/net/wifi/p2p/nsd/WifiP2pServiceResponse;->setSrcDevice(Landroid/net/wifi/p2p/WifiP2pDevice;)V
    ...
    invoke-static {v0, v1}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->access$6200(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;Landroid/net/wifi/p2p/nsd/WifiP2pServiceResponse;)V
    ...
    invoke-virtual/range {v25 .. v26}, Lcom/android/server/wifi/WifiNative;->setMiracastMode(I)V
    ...
    invoke-virtual/range {v25 .. v28}, Lcom/android/server/wifi/WifiNative;->p2pExtListen(ZII)Z
    ...
    invoke-static/range {v25 .. v25}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->access$6300(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;)Ljava/lang/String;
    ...
    # setter for: Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->mLastSetCountryCode:Ljava/lang/String;
    invoke-static {v0, v9}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->access$6302(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 1512
    .local v20, "requestBundle":Landroid/os/Bundle;
    const-string v25, "android.net.wifi.p2p.EXTRA_HANDOVER_MESSAGE"
    ...
    # getter for: Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->mWifiNative:Lcom/android/server/wifi/WifiNative;
    invoke-static/range {v26 .. v26}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->access$400(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;)Lcom/android/server/wifi/WifiNative;

    move-result-object v26

    invoke-virtual/range {v26 .. v26}, Lcom/android/server/wifi/WifiNative;->getNfcHandoverRequest()Ljava/lang/String;
    ...
    .line 1518
    .end local v20    # "requestBundle":Landroid/os/Bundle;
    :sswitch_1a
    ...
    .line 1519
    .local v23, "selectBundle":Landroid/os/Bundle;
    const-string v25, "android.net.wifi.p2p.EXTRA_HANDOVER_MESSAGE"
    ...
    invoke-virtual/range {v26 .. v26}, Lcom/android/server/wifi/WifiNative;->getNfcHandoverSelect()Ljava/lang/String;
    ...
    .line 1526
    .end local v23    # "selectBundle":Landroid/os/Bundle;
    :sswitch_1b
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v25 .. v25}, Lcom/android/server/wifi/WifiNative;->p2pGetChannelList()Ljava/lang/String;

    move-result-object v6

    .line 1527
    .local v6, "channelList":Ljava/lang/String;
    if-eqz v6, :cond_1a
    ...
    # invokes: Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->replyToMessage(Landroid/os/Message;ILjava/lang/Object;)V
    invoke-static {v0, v1, v2, v4}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->access$2000(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;Landroid/os/Message;ILjava/lang/Object;)V
    ...
    .line 1538
    .end local v6    # "channelList":Ljava/lang/String;
    :sswitch_1c
    move-object/from16 v0, p1
    ...
    # setter for: Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->mSupportedBand:I
    invoke-static/range {v25 .. v25}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->access$6402(I)I
    ...
    # getter for: Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->isCmdUpdateChannelListDefered:Z
    invoke-static/range {v25 .. v25}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->access$3800(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;)Z
    ...
    invoke-static {v0, v1}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->access$6500(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;Landroid/os/Message;)V
    ...
    # invokes: Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->deferMessage(Landroid/os/Message;)V
    invoke-static {v0, v1}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->access$6600(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;Landroid/os/Message;)V
    ...
    # setter for: Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->isCmdUpdateChannelListDefered:Z
    invoke-static/range {v25 .. v26}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->access$3802(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;Z)Z
    ...
    const-string v27, "update channel list"
    ...
    invoke-virtual/range {v25 .. v25}, Lcom/android/server/wifi/WifiNative;->updateChannelList()Z
    ...
    invoke-static/range {v25 .. v25}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->access$1500(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;)Landroid/content/Context;
    ...
    const-string v26, "preferred_p2p_configuration"
    ...
    .line 1575
    .local v13, "deviceConf":Ljava/lang/String;
    if-eqz v13, :cond_1e
    ...
    .line 1578
    .local v7, "confToken":[Ljava/lang/String;
    :try_start_1
    move-object/from16 v0, p0
    ...
    invoke-static/range {v25 .. v25}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->access$6700(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;)Landroid/net/wifi/p2p/WifiP2pDeviceConfig;
    ...
    invoke-static/range {v25 .. v25}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->access$5502(I)I
    :try_end_1
    .catch Ljava/lang/NumberFormatException; {:try_start_1 .. :try_end_1} :catch_1

    .line 1584
    .end local v7    # "confToken":[Ljava/lang/String;
    :cond_1e
    :goto_7
    move-object/from16 v0, p0
    ...
    # getter for: Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->mWifiP2pDeviceConfig:Landroid/net/wifi/p2p/WifiP2pDeviceConfig;
    invoke-static/range {v26 .. v26}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->access$6700(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;)Landroid/net/wifi/p2p/WifiP2pDeviceConfig;
    ...
    invoke-virtual/range {v25 .. v26}, Lcom/android/server/wifi/WifiNative;->setMaxNumberStation(I)Z
    ...
    const-string v27, " mP2pAutoConnectSupport = "
    ...
    .line 1582
    .restart local v7    # "confToken":[Ljava/lang/String;
    :catch_1
    move-exception v25
