...
.field static final EVENT_LINE_CONTROL_INFO:I = 0x64
...
.field private mConfigCDMACallTimeAfterFWIMsg:Z
...
.field private mIsLineCtrlReceived:Z
...
.method constructor <init>(Landroid/content/Context;Lcom/android/internal/telephony/DriverCall;Lcom/android/internal/telephony/cdma/CdmaCallTracker;I)V
    ...
    .line 98
    iput-boolean v1, p0, Lcom/android/internal/telephony/cdma/CdmaConnection;->mConfigCDMACallTimeAfterFWIMsg:Z

    .line 99
    iput-boolean v1, p0, Lcom/android/internal/telephony/cdma/CdmaConnection;->mIsLineCtrlReceived:Z
    ...
    iput-boolean v0, p0, Lcom/android/internal/telephony/cdma/CdmaConnection;->mConfigCDMACallTimeAfterFWIMsg:Z

    .line 156
    iget-boolean v0, p0, Lcom/android/internal/telephony/cdma/CdmaConnection;->mConfigCDMACallTimeAfterFWIMsg:Z
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcom/android/internal/telephony/cdma/CDMAPhone;->registerForLineControlInfo(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method constructor <init>(Landroid/content/Context;Ljava/lang/String;Lcom/android/internal/telephony/cdma/CdmaCallTracker;Lcom/android/internal/telephony/cdma/CdmaCall;)V
    ...
    .line 74
    sget-object v3, Lcom/android/internal/telephony/Connection$PostDialState;->NOT_STARTED:Lcom/android/internal/telephony/Connection$PostDialState;

    iput-object v3, p0, Lcom/android/internal/telephony/cdma/CdmaConnection;->mPostDialState:Lcom/android/internal/telephony/Connection$PostDialState;

    .line 75
    iput v2, p0, Lcom/android/internal/telephony/cdma/CdmaConnection;->mPreciseCause:I

    .line 94
    iput-boolean v2, p0, Lcom/android/internal/telephony/cdma/CdmaConnection;->mConnTimerReset:Z

    .line 98
    iput-boolean v2, p0, Lcom/android/internal/telephony/cdma/CdmaConnection;->mConfigCDMACallTimeAfterFWIMsg:Z

    .line 99
    iput-boolean v2, p0, Lcom/android/internal/telephony/cdma/CdmaConnection;->mIsLineCtrlReceived:Z
    ...
    .line 169
    new-instance v3, Lcom/android/internal/telephony/cdma/CdmaConnection$MyHandler;
    ...
    invoke-virtual {v4}, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->getLooper()Landroid/os/Looper;

    move-result-object v4

    invoke-direct {v3, p0, v4}, Lcom/android/internal/telephony/cdma/CdmaConnection$MyHandler;-><init>(Lcom/android/internal/telephony/cdma/CdmaConnection;Landroid/os/Looper;)V

    iput-object v3, p0, Lcom/android/internal/telephony/cdma/CdmaConnection;->mHandler:Landroid/os/Handler;
    ...
    const-string v5, "[CDMAConn] CdmaConnection: dialString="
    ...
    .line 180
    .local v0, "isAssistedDialingEnabled":Z
    :goto_0
    if-nez v0, :cond_3
    ...
    const-string v5, "[CDMAConn] CdmaConnection:formated dialString="
    ...
    iput-object v3, p0, Lcom/android/internal/telephony/cdma/CdmaConnection;->mAddress:Ljava/lang/String;
    ...
    iput-object v3, p0, Lcom/android/internal/telephony/cdma/CdmaConnection;->mPostDialString:Ljava/lang/String;

    .line 192
    const/4 v3, -0x1

    iput v3, p0, Lcom/android/internal/telephony/cdma/CdmaConnection;->mIndex:I

    .line 194
    iput-boolean v2, p0, Lcom/android/internal/telephony/cdma/CdmaConnection;->mIsIncoming:Z

    .line 195
    iput-object v6, p0, Lcom/android/internal/telephony/cdma/CdmaConnection;->mCnapName:Ljava/lang/String;
    ...
    .line 215
    iget-boolean v1, p0, Lcom/android/internal/telephony/cdma/CdmaConnection;->mConfigCDMACallTimeAfterFWIMsg:Z
    ...
    invoke-virtual {v1, v2, v3, v6}, Lcom/android/internal/telephony/cdma/CDMAPhone;->registerForLineControlInfo(Landroid/os/Handler;ILjava/lang/Object;)V

    .line 219
    :cond_1
    return-void

    .end local v0    # "isAssistedDialingEnabled":Z
    :cond_2
    move v0, v2
    ...
    .line 185
    .restart local v0    # "isAssistedDialingEnabled":Z
    :cond_3
...
.method static synthetic access$100(Lcom/android/internal/telephony/cdma/CdmaConnection;Landroid/os/AsyncResult;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/internal/telephony/cdma/CdmaConnection;
    ...
    .prologue
    .line 51
    invoke-direct {p0, p1}, Lcom/android/internal/telephony/cdma/CdmaConnection;->onLineControlInfo(Landroid/os/AsyncResult;)V
...
.method private doDisconnect()V
    ...
    iput-boolean v0, p0, Lcom/android/internal/telephony/cdma/CdmaConnection;->mIsLineCtrlReceived:Z
...
.method private onLineControlInfo(Landroid/os/AsyncResult;)V
    .locals 5
    ...
    .line 1042
    .local v0, "lineCtrlInfo":Lcom/android/internal/telephony/cdma/CdmaInformationRecords$CdmaLineControlInfoRec;
    if-eqz v0, :cond_0
    ...
    const-string v3, "lineCtrlPolarityIncluded = "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-byte v3, v0, Lcom/android/internal/telephony/cdma/CdmaInformationRecords$CdmaLineControlInfoRec;->lineCtrlPolarityIncluded:B
    ...
    .line 1044
    iget-boolean v1, p0, Lcom/android/internal/telephony/cdma/CdmaConnection;->mIsLineCtrlReceived:Z

    if-nez v1, :cond_0

    iget-byte v1, v0, Lcom/android/internal/telephony/cdma/CdmaInformationRecords$CdmaLineControlInfoRec;->lineCtrlPolarityIncluded:B
    ...
    const-string v2, "reset connectTime"
    ...
    .line 1048
    iput-boolean v4, p0, Lcom/android/internal/telephony/cdma/CdmaConnection;->mIsLineCtrlReceived:Z
...
.method public dispose()V
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/cdma/CDMAPhone;->unregisterForLineControlInfo(Landroid/os/Handler;)V
