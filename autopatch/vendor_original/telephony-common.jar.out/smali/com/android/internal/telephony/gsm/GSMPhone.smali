...
.field public static final VM_SIM_ID:Ljava/lang/String; = "vm_sim_id_key"
...
.field protected mOSST:Lcom/android/internal/telephony/gsm/GsmOemServiceStateTracker;
...
.method private getVmSimImsi()Ljava/lang/String;
    ...
    invoke-virtual {p0, v2, v4, v0}, Lcom/android/internal/telephony/gsm/GSMPhone;->syncSpFromKkForSingleSim(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private handleCallWaitingIncallSupplementaryService(Ljava/lang/String;)Z
    ...
    .line 723
    invoke-virtual {v0}, Lcom/android/internal/telephony/gsm/GsmCall;->isDialingOrAlerting()Z
...
.method private isManualSelProhibitedInGlobalMode()Z
    ...
    invoke-direct {v3, v4}, Lcom/motorola/android/content/MSimContext;-><init>(Landroid/content/Context;)V

    invoke-virtual {p0}, Lcom/android/internal/telephony/gsm/GSMPhone;->getSubId()I

    move-result v4

    invoke-virtual {v3, v4}, Lcom/motorola/android/content/MSimContext;->getResources(I)Landroid/content/res/Resources;
...
.method private storeVoiceMailNumber(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v2}, Lcom/android/internal/telephony/gsm/GSMPhone;->setVmSimID(Ljava/lang/String;)V
...
.method private updatePrefsVMCount(I)V
    .locals 4
    .param p1, "vmCount"    # I
...
.method private updateVoiceMail()V
    ...
    :cond_2
    invoke-direct {p0, v0}, Lcom/android/internal/telephony/gsm/GSMPhone;->updatePrefsVMCount(I)V
...
.method protected getCallForwardingPreference()Z
    ...
    invoke-virtual {p0, v2, v4, v0}, Lcom/android/internal/telephony/gsm/GSMPhone;->syncSpFromKkForSingleSim(Ljava/lang/String;ZZ)Z
...
.method protected getServiceProviderName()Ljava/lang/String;
    ...
    .line 2401
    .local v0, "sim":Lcom/android/internal/telephony/uicc/IccRecords;
    if-eqz v0, :cond_0
...
.method protected getVmSimID()Ljava/lang/String;
    .locals 5
...
.method public getVoiceMailNumber()Ljava/lang/String;
    ...
    invoke-virtual {p0, v6, v10, v3}, Lcom/android/internal/telephony/gsm/GSMPhone;->syncSpFromKkForSingleSim(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-interface/range {v19 .. v19}, Lcom/android/internal/telephony/CommandsInterface;->getLteOnCdmaMode()I
    ...
    .line 1687
    :cond_2
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/telephony/gsm/GSMPhone;->setLowCoverageConf()V
    ...
    .line 1706
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/telephony/gsm/GSMPhone;->getVmSimID()Ljava/lang/String;

    move-result-object v9

    .line 1707
    .local v9, "iccid":Ljava/lang/String;
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/telephony/gsm/GSMPhone;->getIccSerialNumber()Ljava/lang/String;

    move-result-object v10

    .line 1708
    .local v10, "iccidFromSIM":Ljava/lang/String;
    if-eqz v9, :cond_3
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/gsm/GSMPhone;->setVmSimID(Ljava/lang/String;)V
    ...
    .end local v10    # "iccidFromSIM":Ljava/lang/String;
    :sswitch_4
    move-object/from16 v0, p1
    ...
    const-string v19, "ril.baseband.config.version"
    ...
    .line 1732
    .local v6, "configVersion":Ljava/lang/String;
    if-eqz v6, :cond_4
    ...
    const-string v21, "Setting baseband version: "
    ...
    .end local v6    # "configVersion":Ljava/lang/String;
    ...
    iget-object v11, v0, Lcom/android/internal/telephony/gsm/GSMPhone;->mImsPhone:Lcom/android/internal/telephony/imsphone/ImsPhone;

    .line 1800
    .local v11, "imsPhone":Lcom/android/internal/telephony/imsphone/ImsPhone;
    if-eqz v11, :cond_7

    .line 1801
    invoke-virtual {v11}, Lcom/android/internal/telephony/imsphone/ImsPhone;->getServiceState()Landroid/telephony/ServiceState;
    ...
    .line 1808
    .end local v8    # "i":I
    .end local v11    # "imsPhone":Lcom/android/internal/telephony/imsphone/ImsPhone;
    :sswitch_a
    move-object/from16 v0, p1
    ...
    invoke-virtual {v12, v3}, Lcom/android/internal/telephony/gsm/GsmMmiCode;->processSsData(Landroid/os/AsyncResult;)V
...
.method notifyPreciseCallStateChanged()V
    ...
    .line 518
    iget-object v0, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mCsLowCoverageConf:Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Lcom/android/internal/telephony/gsm/GSMPhone;->notifyCallStateChange(Z)V
...
.method protected setVmSimID(Ljava/lang/String;)V
    .locals 4
...
.method protected syncClirSetting()V
    ...
    .line 1630
    invoke-virtual {p0, v2}, Lcom/android/internal/telephony/gsm/GSMPhone;->saveClirSetting(I)V
    ...
    const-string v5, "failed to sync CLIR preference"

    invoke-static {v4, v5}, Landroid/telephony/Rlog;->e(Ljava/lang/String;Ljava/lang/String;)I

    .line 1643
    .end local v1    # "editor":Landroid/content/SharedPreferences$Editor;
    .end local v2    # "kkClir":I
    :cond_0
    :goto_0
    if-ltz v0, :cond_1
    ...
    invoke-interface {v4, v0, v5}, Lcom/android/internal/telephony/CommandsInterface;->setCLIR(ILandroid/os/Message;)V
...
.method public updateCurrentCarrierInProvider()Z
    ...
    invoke-virtual {p0, v6, v4, v3}, Lcom/android/internal/telephony/gsm/GSMPhone;->fillMvnoInfoToMap(Lcom/android/internal/telephony/uicc/IccRecords;Ljava/lang/String;Landroid/content/ContentValues;)V
